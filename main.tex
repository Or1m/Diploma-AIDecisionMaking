...
\subsection{Pohyb hráčskej postavy}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=.8\textwidth]{Figures/obruce.png}
...
\label{sec:Agents}
Ako už bolo spomenuté v predchádzajúcich sekciách, projekt obsahuje dva typy NPC agentov. Prvý typ sa rozhoduje na základe rozhodovacieho stromu zostrojeného zo vstupných dát a druhý typ agentov využíva na rozhodovanie model natrénovaný pomocou spätnoväzobného učenia. Jednotlivé typy NPC sa líšia aj v prístupe k navigácií priestorom či kolízií a ďalšími detailami v skladbe či funkcionalite jednotlivých komponentov. 

\subsection{Spoločné prvky oboch typov agentov}
...
\subsection{Štruktúra NPC ovládaných rozhodovacím stromom}
\label{sec:AgentsWithTrees}

\subsection{Štruktúra NPC netrénovaných spätnoväzobným učením}
...
\label{sec:Training}
%TODO + PlayerAutomatic movement, scriptedPath, waypointy
